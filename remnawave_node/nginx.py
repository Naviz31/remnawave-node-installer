...
from .constants import COVER_PORT, NGINX_AVAILABLE, NGINX_ENABLED
from .system import CommandRunner


def nginx_config(domain: str, *, certificate: bool) -> str:
    backend_listen = f"listen 127.0.0.1:{COVER_PORT} ssl;" if certificate else f"listen 127.0.0.1:{COVER_PORT};"
