...
curl -fsSL https://raw.githubusercontent.com/Naviz31/remnawave-node-installer/v1.0.8/install.sh | sudo bash
```
...
Если не хотите сохранять конфиг, допустим одноразовый запуск одной командой: `curl -fsSL https://raw.githubusercontent.com/Naviz31/remnawave-node-installer/v1.0.8/install.sh | sudo env PANEL_IPS="203.0.113.10" bash`. Установщик всё равно спросит домен и ключ.
